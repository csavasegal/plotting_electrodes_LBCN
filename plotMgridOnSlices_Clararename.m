function plotMgridOnSlices_Clararename(fsSub,cfg)
...
for elecId=1:nElec,
    if depthElecs(elecId)
        ...
        %formattedLabel=strcat(formattedLabel,'_elec');
        ...
        formattedLabel=strcat(formattedLabel,'_elec'); %clara
        ...
        if universalYes(printFigs)
            ...
            figFname=fullfile(outPath,sprintf('%s_%s',fsSub,formattedLabel));
